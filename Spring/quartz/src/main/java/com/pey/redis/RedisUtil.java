...
//        String sql="select * from tableName and name ='peimm'";
...
//            if(i==0){
//                sql+="and part_type='"+groupName+"' ";
//            }else if(i<=list.size()) {
//                sql+="or part_type='"+groupName+"' ";
//            }
//
//        }
//        System.out.println("sql="+sql);

        String sql = "select t1.item_id,t1.item_name,t1.is_show,nvl(t2.priority,999) from bm_item_info t1 "
                +" left join  bm_quota_relation t2 "
                +" on t1.item_id=t2.item_id and  t2.parent_id=0 and t2.status=1"
                +" where t1.item_type=1 and t1.status=1 and t1.part_type in(";
        if(groupNames.size()>0){
            ...
            sql+="t1.part_type is null and t1.user_id="+11;
        }
        sql+=" order by t2.priority";
        System.out.println("sql="+sql);
    }
}
